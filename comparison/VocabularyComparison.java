...
// Chapter 10 ArrayList Case Study
// This program allows the user to input two .txt files, and then
// compares the two files...listing the number of same words between
// the two .txt files (counts word overlap).
 ...
 * @author abritton
 */
public class VocabularyComparison {
    ...
    public static void reportResults(ArrayList<String> list1,
        ...
        System.out.println("% of file 1 in overlap = " + pct2);
    }
